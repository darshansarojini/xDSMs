...
x.add_system("weight", SUBOPT, r"\text{Structural Weight Estimation}")
...
x.connect("geom", "aeromech", r'\text{Actuated geometry}')
...
x.connect("aeromech", "weight", r'\text{Critical load cases}')
